...
export default function MapIcon({color, width, height}) {
  return (
      <svg xmlns="http://www.w3.org/2000/svg" width={width ? width : "20"} height={height ? height : "20"} viewBox="0 0 24 24" style={{fill: color? color : "rgba(95, 95, 93, 1)"}}>
